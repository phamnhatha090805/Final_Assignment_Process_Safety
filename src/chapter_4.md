# Chapter 4: Explain the process in detail
## 1. Making Coffee Process
...
## 2. Making Toast Process
Users can only start inserting bread and press the **Lever Down** button if the **coffee state equals 1**, meaning users can start making toast while the water is heating.  
